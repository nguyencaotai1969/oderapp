...
public class SanphamHotFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        for (int i = 0 ;i < 10 ; i ++){
            list.add(new DashboardSanPham(1,"Banh Ngon gì gì gì đâu á",2500,"https://image.flaticon.com/icons/png/128/2971/2971975.png","haha",1));
        }
